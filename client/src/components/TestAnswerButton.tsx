...
export default function TestAnswerButton({
    ...
    return (
        <button
            onClick={onClick}
            className={`w-full px-4 py-6 rounded-xl font-semibold flex items-center gap-4 border hover:brightness-[0.98] active:scale-[0.99] duration-100 ${voteStyles[answer]}`}
        >
            {voteIcons[answer]}
