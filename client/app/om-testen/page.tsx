...
export const metadata: Metadata = {
    ...
    description:
        "Læs om metodikken bag partitesten: hvordan afstemninger udvælges, beregnes og hvordan der sikrer fuld gennemsigtighed og anonymitet.",
    openGraph: {
        title: "Om testen - Hvad skal jeg stemme?",
        description:
            "Læs om metodikken bag partitesten: hvordan afstemninger udvælges, beregnes og hvordan der sikrer fuld gennemsigtighed og anonymitet.",
...
export default function OmTestenPage() {
    return (
        <Section className="py-6 flex flex-col gap-6 md:py-8 bg-white">
            <div className="grid gap-2">
                <PageHeading>Om testen</PageHeading>
                <p className="text-gray-600 text-sm">
                    Vi har gennemgået samtlige afstemninger i Folketinget i seneste
                    valgperiode for at lave en partitest, der bygger på, hvordan
                    partierne har stemt i Folketinget, og ikke hvad de lover under en
                    valgkamp.
                </p>
            </div>
